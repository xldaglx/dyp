...
class BehaviorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create behavior" do
    assert_difference('Behavior.count') do
      post behaviors_url, params: { behavior: { deal_id: @behavior.deal_id, grade: @behavior.grade, user_id: @behavior.user_id } }
    end
  ...
  test "should update behavior" do
    patch behavior_url(@behavior), params: { behavior: { deal_id: @behavior.deal_id, grade: @behavior.grade, user_id: @behavior.user_id } }
